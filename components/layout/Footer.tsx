			...
			<div className="border-t border-gray-800">
				<div className="container px-5 py-8 flex flex-wrap mx-auto items-center">
					...
					<span className="inline-flex lg:ml-auto lg:mt-0 mt-6 w-full justify-center md:justify-start md:w-auto">
						<a className="text-gray-400 cursor-pointer hover:text-indigo-500">
							<svg
								fill="currentColor"
								strokeLinecap="round"
						...
						<a className="ml-3 text-gray-400 cursor-pointer hover:text-indigo-500">
							<svg
								fill="currentColor"
								strokeLinecap="round"
								strokeLinejoin="round"
			...
			<div className="bg-gray-800 bg-opacity-75">
				<div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
					<p className="text-gray-400 text-sm text-center sm:text-left">
						&copy;{new Date().getFullYear()} Hexgo —
						<a
							href="https://github.com/tonoy30"
							className="text-gray-400 ml-1 hover:text-indigo-400"
							target="_blank"
					...
					<span className="sm:ml-auto sm:mt-0 mt-2 sm:w-auto w-full sm:text-left text-center text-gray-400 text-sm capitalize">
